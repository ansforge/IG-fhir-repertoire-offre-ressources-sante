...
* extension[ror-healthcareservice-contact].extension[RORConfidentialityLevel] -> "niveauConfidentialite"
* extension[ror-healthcareservice-contact].extension[RORContactFunctionContact] -> "fonctionContact"
* extension[ror-healthcareservice-contact].extension[RORHealthcareServiceContactTelecom] -> "telecom"
* extension[ror-healthcareservice-contact].extension[RORHealthcareServiceContactTelecom].extension[telecomAddress] -> "adresseTelecom"
* extension[ror-healthcareservice-contact].extension[RORHealthcareServiceContactTelecom].extension[RORTelecomCommunicationChannel] -> "canal"
* extension[ror-healthcareservice-contact].extension[RORHealthcareServiceContactTelecom].extension[RORTelecomUsage] -> "utilisation"
* extension[ror-healthcareservice-contact].extension[RORHealthcareServiceContactTelecom].extension[RORTelecomConfidentialityLevel] -> "niveauConfidentialite"
