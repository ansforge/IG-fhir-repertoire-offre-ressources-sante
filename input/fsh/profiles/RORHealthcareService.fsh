...
RG_EXP_009 : Chaque instance de la zone d’intervention DOIT être composée par des instances de DivisionTerritoriale de type Commune (code 3 - Commune du JDV-J223-TypeDivisionTerritoriale-ROR)."
