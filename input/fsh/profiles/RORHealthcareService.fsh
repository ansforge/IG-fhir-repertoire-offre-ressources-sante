...
* availableTime.extension[ror-available-time-type-of-time] -> "ypePlageHoraire"
* availableTime.extension[ror-available-time-effective-opening-closing-date] -> "debutDateEffective & horaire.finDateEffective"
