...
* name -> "nomOffre"
* category -> "typeOffre : JDV-J238-TypeOffre-ROR"
* type -> "champActivite : JDV-J20-ChampActivite-ROR"
* active -> "Pas d'équivalent"

* characteristic[receptionType] -> "temporaliteAccueil : JDV-J30-TemporaliteAccueil-ROR"
* characteristic[careMode] -> "modePriseEnCharge : JDV-J19-ModePriseEnCharge-ROR"
* characteristic[receptionModality] -> "modaliteAccueil : JDV-J226-ModaliteAccueil-ROR"
* characteristic[managementType] -> "modeGestion : JDV-J26-ModeGestion-ROR"
* characteristic[specificAct] -> "acteSpecifique : JDV-J16-ActeSpecifique-ROR"
* characteristic[outsideOfficeAct] -> "acteRealiseHorsCabinet : JDV-J16-ActeSpecifique-ROR"
* characteristic[takingCareSpeciality] -> "specialisationPriseEnCharge : JDV-J35-SpecialisationDePriseEnCharge-ROR"
* characteristic[annualOpening] -> "ouvertureAnnuelle : JDV-J28-OuvertureAnnuelle-ROR"
* characteristic[ressourceProfession] -> "professionRessource : JDV-J186-ProfessionRessource-ROR"
* characteristic[specificCompetence] -> "competenceSpecifique : JDV-J33-CompetenceSpecifique-ROR"
* characteristic[expertiseLevel] -> "niveauExpertise : JDV-J227-NiveauExpertise-ROR"
* characteristic[temporalityStopService] -> "typeFermeture : JDV-J185-TypeFermeture-ROR"
...
* availableTime.extension[ror-available-time-type-of-time] -> "typePlageHoraire : JDV-J41-TypeHoraire-ROR"
...
* extension[ror-healthcareservice-contact].extension[purposeContact] -> "natureContact : JDV-J221-NatureContact-ROR"
* extension[ror-healthcareservice-contact].extension[description] -> "description"
* extension[ror-healthcareservice-contact].extension[ror-confidentiality-level] -> "niveauConfidentialite : JDV-J222-NiveauConfidentialite-ROR"
* extension[ror-healthcareservice-contact].extension[ror-contact-function-contact] -> "fonctionContact : JDV-J220-FonctionContact-ROR"
...
* extension[ror-healthcareservice-contact].extension[ror-healthcareservice-contact-telecom].extension[ror-telecom-communication-channel] -> "canal : JDV-J225-CanalCommunication-ROR"
...
* extension[ror-healthcareservice-contact].extension[ror-healthcareservice-contact-telecom].extension[ror-telecom-confidentiality-level] -> "niveauConfidentialite : JDV-J222-NiveauConfidentialite-ROR"

* extension[ror-healthcareservice-patient-type] -> "Patientele"
* extension[ror-healthcareservice-patient-type].extension[supportedPatientInfo] -> "publicPrisEnCharge : JDV-J29-PublicPrisEnCharge-ROR"
