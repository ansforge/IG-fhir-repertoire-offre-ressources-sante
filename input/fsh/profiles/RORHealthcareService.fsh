...
* meta.tag[codeRegion] -> "metadonnee.regionSource"
...
* extension[ror-healthcareservice-patient-type] -> "Patientele.publicPrisEnCharge"
...
* specialty[operationalActivityFamily] -> "familleActiviteOperationnelle"
* name -> "nomOffre"
...
* availableTime.availableStartTime -> "horaire.heureDebut"
* availableTime.availableEndTime -> "horaire.heureFin"
* availableTime.extension[ror-available-time-type-of-time] -> "horaire.typePlageHoraire"
* availableTime.extension[ror-available-time-effective-opening-closing-date] -> "horaire.debutDateEffective & horaire.finDateEffective"
* availableTime.extension[ror-available-time-number-days-of-week] -> "horaire.jourSemaine"
* notAvailable[closingRepoeningDate] -> "dateFermeture & datePrevisionnelleReouverture"