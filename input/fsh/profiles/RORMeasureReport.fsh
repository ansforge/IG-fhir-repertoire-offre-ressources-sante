...
* subject Reference(RORPractitioner or RORPractitionerRole or RORLocation)
* reporter Reference(RORPractitioner or RORPractitionerRole or RORLocation or ROROrganization)
* date 1..1 MS
