Profile: RORInternalOrganization
...
/* Références*/
* partOf only Reference(ROROrganization or RORInternalOrganization)
* partOf MS
* partOf ^short = "Rattachement à l'entité géographique (EG) ou au pôle/service parent"
...
* name MS
* name ^short = "nomOI (OI) : Nom de l'organisation interne (pôle ou service)"
...
Mapping:  ConceptMetier_RORInternalOrganization_OI
Source:   RORInternalOrganization
Target:   "https://esante.gouv.fr/sites/default/files/media/document/ROR_ME_V3.0.1_ModeleExposition_VFD_20260316.pdf"
Id:       specmetier-to-RORInternalOrganization-oi
Title:    "OrganisationInterne (pôle / service) du Modèle exposition ROR V3"
