...
* extension[ror-location-equipment].extension[ror-location-equipment-limit] -> "LimiteCaracteristiqueEquipement"
* extension[ror-location-equipment].extension[ror-location-equipment-limit].extension[equipmentFeature] -> "typeCaracteristique : JDV-J228-TypeCaracteristiqueEquipement-ROR"
* extension[ror-location-equipment].extension[ror-location-equipment-limit].extension[limitValue] -> "valeurLimite"
