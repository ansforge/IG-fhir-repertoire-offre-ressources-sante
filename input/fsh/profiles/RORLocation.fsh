...
* position.extension[ror-coordinate-reliability] -> "systemeGeodesique"

* extension[ror-location-status] -> "statut"
* extension[ror-commune-cog] -> "communeCog"

* extension[ror-location-equipment] -> "EquipementSpecifique"
* extension[ror-location-equipment].extension[equipmentType] -> "typeEquipement"
...
* extension[ror-location-equipment-limit].extension[equipmentFeature] -> "typeCaracteristique"
...
* extension[ror-location-residential-capacity].extension[residentialType] -> "typeHabitation"
...
* extension[ror-location-supported-capacity].extension[capacityType] -> "CapaciteAccueilOperationnelle.natureCapacite"
* extension[ror-location-supported-capacity].extension[capacityStatus] -> "CapaciteAccueilOperationnelle.statutCapacite"
* extension[ror-location-supported-capacity].extension[temporalityCapacity] -> "CapaciteAccueilOperationnelle.temporaliteCapacite"
* extension[ror-location-supported-capacity].extension[nbCapacity] -> "CapaciteAccueilOperationnelle.nombreCapacite"
* extension[ror-location-supported-capacity].extension[capacitySourceType] -> "CapaciteAccueilOperationnelle.typeSourceCapacite"
* extension[ror-location-supported-capacity].extension[genderCapacityAvailable] -> "CapaciteAccueilOperationnelle.genreCapaciteDispo"
* extension[ror-location-supported-capacity].extension[capacityUpdateDate] -> "CapaciteAccueilOperationnelle.dateMAJCapacite"
* extension[ror-location-supported-capacity].extension[capacityClosingType] -> "CapaciteAccueilOperationnelle.typeFermetureCapacite"
* extension[ror-location-supported-capacity].extension[additionalBedType] -> "CapaciteAccueilOperationnelle.typeLitsSupplementaire"
* extension[ror-location-supported-capacity].extension[crisisType] -> "CapaciteAccueilOperationnelle.typeCrise"
* extension[ror-location-supported-capacity].extension[temporaryAssignement] -> "CapacitePriseCharge.affectationTemporaire"