...
* healthcareService only Reference(RORHealthcareService)
...
* identifier[idSituationExercice] 0..1 MS
* identifier[idSituationExercice] ^short = "identifiantSituationOperationnelle (SituationOperationnelle) : Identifiant de la situation opérationnelle, unique et persistant au niveau national"
...
* extension[as-ext-practitionerrole-contracted] ^short = "secteurConventionnement (SituationOperationnelle) : Secteur de conventionnement du professionnel libéral auquel il a adhéré auprès de l'Assurance Maladie"
* extension[as-ext-practitionerrole-contracted].valueCodeableConcept from $JDV-J218-CNAMAmeliSecteurConventionnement-ROR (required)
* extension[as-ext-practitionerrole-hascas] MS
* extension[as-ext-practitionerrole-hascas] ^short = "optionContratAccèsAuxSoins (SituationOperationnelle) : L'Option pratique tarifaire maîtrisée (OPTAM) a remplacé le Contrat d'accès aux soins (CAS) en 2017"
...
* identifier[idSituationExercice] -> "identifiantSituationOperationnelle" "Similaire aux accès de metadonnee.identifiant"
...
* extension[as-ext-practitionerrole-contracted].valueCodeableConcept -> "secteurConventionnement" "Similaire aux accès de metadonnee.identifiant"
* extension[as-ext-practitionerrole-hascas] -> "optionContratAccèsAuxSoins" "Similaire aux accès de metadonnee.identifiant"
* extension[as-ext-practitionerrole-vitale-accepted] -> "carteVitaleAcceptee" "Similaire aux accès de metadonnee.identifiant"
