...
| Draft as of 2026-08-26 | *Computable Name*:ROR |
...
| [RORCoreOrganizationUF](StructureDefinition-ror-core-organization-uf.md) | Profil créé dans le cadre du ROR pour décrire les unités fonctionnelles (UF) médicales, rattachées à un pôle/service ou à une entité géographique (EG) |
...
| [RORInternalOrganization](StructureDefinition-ror-internal-organization.md) | Profil créé dans le cadre du ROR pour décrire les organisations internes de type pôle ou service, rattachées à une entité géographique (EG) |
...
* [ISO 3166-1 Codes for the representation of names of countries and their subdivisions — Part 1: Country code](http://terminology.hl7.org/5.5.0/CodeSystem-ISO3166Part1.html): [ActTypeRORCodeSystem](CodeSystem-act-type-ror-codesystem.md), [ActTypeRORValueSet](ValueSet-act-type-ror-valueset.md)... Show 107 more, [AsLieuDit](StructureDefinition-as-ext-lieu-dit.md), [CodeRegionTerritorialDivisionRORValueSet](ValueSet-code-region-territorial-division-ror-valueset.md), [InputTaskRORCodeSystem](CodeSystem-input-task-ror-codesystem.md), [LocationNearINSEECode](SearchParameter-ror-sp-location-near-insee-code.md), [MS-141](Questionnaire-ror-questionnaire-offre-mco.md), [OutputTaskRORCodeSystem](CodeSystem-output-task-ror-codesystem.md), [ROR](index.md), [RORActType](StructureDefinition-ror-act-type.md), [RORAvailableTimeEffectiveOpeningClosingDate](StructureDefinition-ror-available-time-effective-opening-closing-date.md), [RORAvailableTimeNumberDaysofWeek](StructureDefinition-ror-available-time-number-days-of-week.md), [RORAvailableTimeTypeOfTime](StructureDefinition-ror-available-time-type-of-time.md), [RORComment](StructureDefinition-ror-comment.md), [RORCommuneCog](StructureDefinition-ror-commune-cog.md), [RORConfidenceGeolocation](StructureDefinition-ror-confidence-geolocation.md), [RORConfidentialityLevel](StructureDefinition-ror-confidentiality-level.md), [RORConsommateur](CapabilityStatement-ror-consommateur.md), [RORContactConfidentialityLevel](StructureDefinition-ror-contact-confidentiality-level.md), [RORContactDescription](StructureDefinition-ror-contact-description.md), [RORContactFunctionContact](StructureDefinition-ror-contact-function-contact.md), [RORContactTelecomConfidentialityLevel](StructureDefinition-ror-contact-telecom-confidentiality-level.md), [RORContactTelecomUsage](StructureDefinition-ror-contact-telecom-usage.md), [RORCoordinateReliability](StructureDefinition-ror-coordinate-reliability.md), [RORCoreOrganizationUF](StructureDefinition-ror-core-organization-uf.md), [RORHealthcareService](StructureDefinition-ror-healthcareservice.md), [RORHealthcareServiceAgeRangeHigh](SearchParameter-ror-sp-healthcareservice-age-range-high.md), [RORHealthcareServiceAgeRangeLow](SearchParameter-ror-sp-healthcareservice-age-range-low.md), [RORHealthcareServiceContact](StructureDefinition-ror-healthcareservice-contact.md), [RORHealthcareServiceContactTelecom](StructureDefinition-ror-healthcareservice-contact-telecom.md), [RORHealthcareServiceEquipmentType](SearchParameter-ror-sp-healthcareservice-equipment-type.md), [RORHealthcareServiceInterventionZone](SearchParameter-ror-sp-healthcareservice-intervention-zone.md), [RORHealthcareServiceNoConsentHabilitation](StructureDefinition-ror-healthcareservice-no-consent-habilitation.md), [RORHealthcareServicePatientType](StructureDefinition-ror-healthcareservice-patient-type.md), [RORHealthcareServicePsychiatricSector](StructureDefinition-ror-healthcareservice-psychiatric-sector.md), [RORHealthcareServiceSensitiveUnit](StructureDefinition-ror-healthcareservice-sensitive-unit.md), [RORHealthcareServiceSupportedPatientType](SearchParameter-ror-sp-healthcareservice-patient-type.md), [RORInternalOrganization](StructureDefinition-ror-internal-organization.md), [RORLaunchContextCodeSystem](CodeSystem-ror-launch-context-codesystem.md), [RORLaunchContextExtension](StructureDefinition-ror-launchcontext.md), [RORLaunchContextVS](ValueSet-ror-launch-context-vs.md), [RORLocation](StructureDefinition-ror-location.md), [RORLocationEquipment](StructureDefinition-ror-location-equipment.md), [RORLocationEquipmentLimit](StructureDefinition-ror-location-equipment-limit.md), [RORLocationResidentialCapacity](StructureDefinition-ror-location-residential-capacity.md), [RORLocationSupportedCapacity](StructureDefinition-ror-location-supported-capacity.md), [RORMeasure](StructureDefinition-ror-measure.md), [RORMeasureReport](StructureDefinition-ror-measurereport.md), [RORMetaComment](StructureDefinition-ror-meta-comment.md), [RORMetaCreationDate](StructureDefinition-ror-meta-creation-date.md), [RORMetaQuestionnaireUsedAsATemplate](StructureDefinition-ror-meta-questionnaire-used-as-a-template.md), [ROROrganization](StructureDefinition-ror-organization.md), [ROROrganizationAccessibilityLocation](StructureDefinition-ror-organization-accessibility-location.md), [ROROrganizationAccomodationFamily](StructureDefinition-ror-organization-accomodation-family.md), [ROROrganizationAdditionalName](StructureDefinition-ror-organization-additional-name.md), [ROROrganizationClosingType](StructureDefinition-ror-organization-closing-type.md), [ROROrganizationComment](StructureDefinition-ror-organization-comment.md), [ROROrganizationCreationDate](StructureDefinition-ror-organization-creation-date.md), [ROROrganizationDropZone](StructureDefinition-ror-organization-drop-zone.md), [ROROrganizationFinancialHelpType](StructureDefinition-ror-organization-financial-help-type.md), [ROROrganizationLevelRecourseORSAN](StructureDefinition-ror-organization-level-recours-orsan.md), [ROROrganizationNbPermanentSocialHelpPlace](StructureDefinition-ror-organization-nb-permanent-social-help-place.md), [ROROrganizationNbTemporarySocialHelpPlace](StructureDefinition-ror-organization-nb-temporary-social-help-place.md), [ROROrganizationPeriodEnd](SearchParameter-ror-sp-organization-period-end.md), [ROROrganizationPrice](StructureDefinition-ror-organization-price.md), [ROROrganizationReopeningDate](StructureDefinition-ror-organization-reopening-date.md), [RORPerson](StructureDefinition-ror-person.md), [RORPractitioner](StructureDefinition-ror-practitioner.md), [RORPractitionerRole](StructureDefinition-ror-practitionerrole.md), [RORPractitionerRoleUnitExerciseMode](StructureDefinition-ror-practitionerrole-unit-exercise-mode.md), [RORQuestionnaire](StructureDefinition-ror-questionnaire-healthcareservice.md), [RORQuestionnaireStatusVS](ValueSet-ror-questionnaire-status-vs.md), [RORSPAdditionalBedType](SearchParameter-ror-sp-additional-bed-type.md), [RORSPCapacityClosingType](SearchParameter-ror-sp-capacity-closing-type.md), [RORSPCapacityStatus](SearchParameter-ror-sp-capacity-status.md), [RORSPCapacityType](SearchParameter-ror-sp-capacity-type.md), [RORSPCapacityUpdateDate](SearchParameter-ror-sp-capacity-update-date.md), [RORSPCrisisType](SearchParameter-ror-sp-crisis-type.md), [RORSPEquipmentFeature](SearchParameter-ror-sp-equipment-feature.md), [RORSPEquipmentType](SearchParameter-ror-sp-equipment-type.md), [RORSPGenderCapacityAvailable](SearchParameter-ror-sp-gender-capacity-available.md), [RORSPHealthcareServiceNotAvailableClosingReopeningDate](SearchParameter-ror-sp-healthcareservice-notavailable-closing-reopeningdate.md), [RORSPLimitValue](SearchParameter-ror-sp-limit-value.md), [RORSPLocationCommuneCOG](SearchParameter-ror-sp-location-commune-cog.md), [RORSPNbCapacity](SearchParameter-ror-sp-nb-capacity.md), [RORSPOrganizationDropZone](SearchParameter-ror-sp-organization-drop-zone.md), [RORSPOrganizationOIName](SearchParameter-ror-sp-organization-oi-name.md), [RORSPOrganizationPriceAmountValue](SearchParameter-ror-sp-organization-price-amount-value.md), [RORSPOrganizationPriceDependecyLevel](SearchParameter-ror-sp-organization-price-dependency-level.md), [RORSPOrganizationPriceResidentialType](SearchParameter-ror-sp-organization-price-residential-type.md), [RORSPOrganizationPriceSpecialPrice](SearchParameter-ror-sp-organization-special-price.md), [RORSPOrganizationPriceType](SearchParameter-ror-sp-organization-price-type.md), [RORSPOrganizationPriceUnit](SearchParameter-ror-sp-organization-price-unit.md), [RORSPOrganizationPriceValidityStartDate](SearchParameter-ror-sp-organization-price-validity-start-date.md), [RORSPOrganizationPriceWelcomeType](SearchParameter-ror-sp-organization-price-welcome-type.md), [RORSPResidentialNumber](SearchParameter-ror-sp-residential-number.md), [RORSPResidentialType](SearchParameter-ror-sp-residential-type.md), [RORSPTemporalityCapacity](SearchParameter-ror-sp-temporality-capacity.md), [RORSPTemporaryAssignement](SearchParameter-ror-sp-temporary-assignement.md), [RORServeur](CapabilityStatement-ror-serveur.md), [RORTask](StructureDefinition-ror-task.md), [RORTelecomCommunicationChannel](StructureDefinition-ror-telecom-communication-channel.md), [RORTelecomConfidentialityLevel](StructureDefinition-ror-telecom-confidentiality-level.md), [RORTelecomUsage](StructureDefinition-ror-telecom-usage.md), [RORTerritorialDivision](StructureDefinition-ror-territorial-division.md), [RORUsageContextTypeVS](ValueSet-ror-usage-context-type-vs.md), [RorIncludeAssociatedDataCodeSystem](CodeSystem-ror-include-associated-data-code-system.md), [RorIncludeAssociatedDataVS](ValueSet-ror-include-associated-data-vs.md) and [UsageContextRORCodeSystem](CodeSystem-usage-context-ror-codesystem.md)
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "description" : "Profil créé dans le cadre du ROR pour décrire les organisations internes de type pôle ou service, rattachées à une entité géographique (EG)",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
