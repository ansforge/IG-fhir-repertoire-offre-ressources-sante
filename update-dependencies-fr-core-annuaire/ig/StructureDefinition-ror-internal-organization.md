# RORInternalOrganization - Répertoire national de l’Offre et des Ressources en santé et accompagnement médico-social v0.7.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **RORInternalOrganization**

## Resource Profile: RORInternalOrganization 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-internal-organization | *Version*:0.7.0 |
| Draft as of 2026-07-23 | *Computable Name*:RORInternalOrganization |
...
* Référence ce Profil: [RORCoreOrganizationUF](StructureDefinition-ror-core-organization-uf.md), [RORHealthcareService](StructureDefinition-ror-healthcareservice.md), [RORInternalOrganization](StructureDefinition-ror-internal-organization.md), [RORMeasureReport](StructureDefinition-ror-measurereport.md) and [RORTask](StructureDefinition-ror-task.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.ror|current/StructureDefinition/ror-internal-organization)
...
Other representations of profile: [CSV](StructureDefinition-ror-internal-organization.csv), [Excel](StructureDefinition-ror-internal-organization.xlsx), [Schematron](StructureDefinition-ror-internal-organization.sch) 
...
```json
{
  ...
  "id" : "ror-internal-organization",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-internal-organization",
  "version" : "0.7.0",
  ...
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "specmetier-to-RORInternalOrganization-oi",
    "uri" : "https://esante.gouv.fr/sites/default/files/media/document/ROR_ME_V3.0.1_ModeleExposition_VFD_20260316.pdf",
    "name" : "OrganisationInterne (pôle / service) du Modèle exposition ROR V3"
  },
  {
    "identity" : "v2",
    "uri" : "http://hl7.org/v2",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "nomOI (OI) : Nom de l'organisation interne (pôle ou service)",
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-RORInternalOrganization-oi",
        "map" : "nomOI",
    ...
    },
    {
      ...
      "short" : "Rattachement à l'entité géographique (EG) ou au pôle/service parent",
      "type" : [{
        "extension" : [{
