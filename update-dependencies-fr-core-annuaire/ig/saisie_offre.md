# Saisie de l'offre - Répertoire national de l’Offre et des Ressources en santé et accompagnement médico-social v0.7.0
...
| **Ressource recherchée** | Organization, HealthcareService, Practitioner, PractitionerRole |
| **Construction requête de base** | `POST [base]/[Ressource]{?{&_format=[mime-type]}}` |
