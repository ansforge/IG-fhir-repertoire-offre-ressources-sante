...
## Profil de ressource: RORHealthcareService 
...
Obligatoire : 10 éléments(9 éléments obligatoire(s) imbriqué(s))
 Must-Support : 57 éléments
 Interdit : 10 éléments
...
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-sensitive-unit|0.7.0](StructureDefinition-ror-healthcareservice-sensitive-unit.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-no-consent-habilitation|0.7.0](StructureDefinition-ror-healthcareservice-no-consent-habilitation.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-psychiatric-sector|0.7.0](StructureDefinition-ror-healthcareservice-psychiatric-sector.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-patient-type|0.7.0](StructureDefinition-ror-healthcareservice-patient-type.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-contact|0.7.0](StructureDefinition-ror-healthcareservice-contact.md)
...
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-act-type|0.7.0](StructureDefinition-ror-act-type.md)
...
* The element 1 is sliced based on the value of HealthcareService.meta.tag
* The element 1 is sliced based on the value of HealthcareService.specialty
* The element 2 is sliced based on the values of HealthcareService.characteristic
* The element 1 is sliced based on the value of HealthcareService.notAvailable
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-healthcareservice.csv), [Excel](../StructureDefinition-ror-healthcareservice.xlsx), [Schematron](../StructureDefinition-ror-healthcareservice.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-sensitive-unit|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-RORHealthcareService",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-no-consent-habilitation|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-RORHealthcareService",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-psychiatric-sector|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-RORHealthcareService",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-patient-type|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-RORHealthcareService",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-healthcareservice-contact|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-RORHealthcareService",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-act-type|0.7.0"]
      }],
      "mustSupport" : true
    },
    {
