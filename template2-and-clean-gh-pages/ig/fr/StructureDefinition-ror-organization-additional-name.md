...
Extension simple avec le type string : Extension créée dans le cadre du ROR pour nom complémentaire de l'EJ (complementRaisonSociale) ou nom complémentaire de l'EG (DenominationEG)
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-organization-additional-name.csv), [Excel](../StructureDefinition-ror-organization-additional-name.xlsx), [Schematron](../StructureDefinition-ror-organization-additional-name.sch) 
