...
Extension simple avec le type string : Extension créée dans le cadre du ROR
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-contact-telecom-usage.csv), [Excel](../StructureDefinition-ror-contact-telecom-usage.xlsx), [Schematron](../StructureDefinition-ror-contact-telecom-usage.sch) 
