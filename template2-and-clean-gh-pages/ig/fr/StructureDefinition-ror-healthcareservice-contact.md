...
Extension complexe: Extension créée dans le cadre du ROR pour décrire la personne ou le service qui agit comme point de contact de l'offre.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-healthcareservice-contact.csv), [Excel](../StructureDefinition-ror-healthcareservice-contact.xlsx), [Schematron](../StructureDefinition-ror-healthcareservice-contact.sch) 
