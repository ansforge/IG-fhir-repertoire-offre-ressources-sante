...
## Profil de ressource: RORQuestionnaire 
...
Cette structure est dérivée de [SDCQuestionnairePopulateExpression](http://hl7.org/fhir/uv/sdc/STU3/StructureDefinition-sdc-questionnaire-pop-exp.html) 
...
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-launchcontext|0.7.0](StructureDefinition-ror-launchcontext.md)

**Slices**

Cette structure définit les [slices](http://hl7.org/fhir/R4/profiling.html#slices) suivantes:

* The element 1 is sliced based on the value of Questionnaire.useContext
* The element 1 is sliced based on the value of Questionnaire.useContext.value[x]
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-questionnaire-healthcareservice.csv), [Excel](../StructureDefinition-ror-questionnaire-healthcareservice.xlsx), [Schematron](../StructureDefinition-ror-questionnaire-healthcareservice.sch) 
...
```json
{
  ...
  "extension" : [{
    ...
    "valueCanonical" : "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-extr-defn|3.0.0"
  }],
  ...
  "abstract" : false,
  "type" : "Questionnaire",
  "baseDefinition" : "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-pop-exp|3.0.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-launchcontext|0.7.0"]
      }]
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/ror/ValueSet/ror-questionnaire-status-vs|0.7.0"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/ror/ValueSet/ror-usage-context-type-vs|0.7.0"
      }
    },
    {
