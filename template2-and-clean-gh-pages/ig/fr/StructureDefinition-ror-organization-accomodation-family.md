...
Extension simple avec le type boolean : Extension créée dans le cadre du ROR pour préciser si l'établissement peut héberger les familles des personnes prises en charge.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-organization-accomodation-family.csv), [Excel](../StructureDefinition-ror-organization-accomodation-family.xlsx), [Schematron](../StructureDefinition-ror-organization-accomodation-family.sch) 
