...
Extension simple avec le type dateTime : Extension créée dans le cadre du ROR qui correspond à la date de création (dans le ROR régional) présente dans les métadonnées.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-meta-creation-date.csv), [Excel](../StructureDefinition-ror-meta-creation-date.xlsx), [Schematron](../StructureDefinition-ror-meta-creation-date.sch) 
