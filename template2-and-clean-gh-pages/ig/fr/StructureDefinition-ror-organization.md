...
## Profil de ressource: ROROrganization 

 
Profil créé dans le cadre du ROR pour décrire les organismes du domaine sanitaire, médico-social et social immatriculés dans le FINESS et les organisations internes 

**Utilisations:**

* Référence ce Profil: [RORHealthcareService](StructureDefinition-ror-healthcareservice.md), [RORLocation](StructureDefinition-ror-location.md), [RORMeasureReport](StructureDefinition-ror-measurereport.md), [ROROrganization](StructureDefinition-ror-organization.md)... Show 3 more, [RORPractitioner](StructureDefinition-ror-practitioner.md), [RORPractitionerRole](StructureDefinition-ror-practitionerrole.md) and [RORTask](StructureDefinition-ror-task.md)
...
Obligatoire : 2 éléments(7 éléments obligatoire(s) imbriqué(s))
 Must-Support : 70 éléments
 Interdit : 1 élément
...
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-price|0.7.0](StructureDefinition-ror-organization-price.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-territorial-division|0.7.0](StructureDefinition-ror-territorial-division.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-financial-help-type|0.7.0](StructureDefinition-ror-organization-financial-help-type.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-accomodation-family|0.7.0](StructureDefinition-ror-organization-accomodation-family.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-nb-permanent-social-help-place|0.7.0](StructureDefinition-ror-organization-nb-permanent-social-help-place.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-nb-temporary-social-help-place|0.7.0](StructureDefinition-ror-organization-nb-temporary-social-help-place.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-accessibility-location|0.7.0](StructureDefinition-ror-organization-accessibility-location.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-level-recours-orsan|0.7.0](StructureDefinition-ror-organization-level-recours-orsan.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-drop-zone|0.7.0](StructureDefinition-ror-organization-drop-zone.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-reopening-date|0.7.0](StructureDefinition-ror-organization-reopening-date.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-creation-date|0.7.0](StructureDefinition-ror-organization-creation-date.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-closing-type|0.7.0](StructureDefinition-ror-organization-closing-type.md)
* [http://hl7.org/fhir/StructureDefinition/organization-period|5.2.0](http://hl7.org/fhir/extensions/5.2.0/StructureDefinition-organization-period.html)
...
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-comment|0.7.0](StructureDefinition-ror-organization-comment.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-additional-name|0.7.0](StructureDefinition-ror-organization-additional-name.md)
...
* [http://hl7.org/fhir/StructureDefinition/geolocation|5.2.0](http://hl7.org/fhir/extensions/5.2.0/StructureDefinition-geolocation.html)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-confidence-geolocation|0.7.0](StructureDefinition-ror-confidence-geolocation.md)
...
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-contact-function-contact|0.7.0](StructureDefinition-ror-contact-function-contact.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-contact-description|0.7.0](StructureDefinition-ror-contact-description.md)
* [https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-contact-confidentiality-level|0.7.0](StructureDefinition-ror-contact-confidentiality-level.md)

**Slices**

Cette structure définit les [slices](http://hl7.org/fhir/R4/profiling.html#slices) suivantes:

* The element 1 is sliced based on the value of Organization.meta.tag
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-organization.csv), [Excel](../StructureDefinition-ror-organization.xlsx), [Schematron](../StructureDefinition-ror-organization.sch) 
...
```json
{
  ...
  {
    "identity" : "specmetier-to-ROROrganization-oi",
    "uri" : "https://esante.gouv.fr/sites/default/files/media/document/ROR_ME_V3.0.1_ModeleExposition_VFD_20260316.pdf",
    "name" : "OrganisationInterne du Modèle exposition ROR V3"
  }],
  "kind" : "resource",
  "abstract" : false,
  "type" : "Organization",
  "baseDefinition" : "http://interopsante.org/fhir/StructureDefinition/FrOrganization|1.0.1",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-price|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-territorial-division|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-financial-help-type|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-accomodation-family|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-nb-permanent-social-help-place|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-nb-temporary-social-help-place|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-accessibility-location|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-level-recours-orsan|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-drop-zone|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-reopening-date|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-oi",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-creation-date|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-ej",
    ...
    },
    {
      ...
      "short" : "typeFermeture (EJ + EG + OI) : Le type de fermeture d'un niveau organisationnel indique la temporalité de la fermeture.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-closing-type|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-ej",
    ...
    },
    {
      ...
      "short" : "dateOuverture (EG + OI) + dateFermeture (EJ + EG + OI)",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-comment|0.7.0"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-eg",
    ...
    {
      "id" : "Organization.identifier:finess.type",
      "path" : "Organization.identifier.type",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://mos.esante.gouv.fr/NOS/TRE_G07-TypeIdentifiantStructure/FHIR/TRE-G07-TypeIdentifiantStructure",
    ...
    {
      "id" : "Organization.identifier:sirene",
      "path" : "Organization.identifier",
      "sliceName" : "sirene",
    ...
    {
      "id" : "Organization.identifier:sirene.type",
      "path" : "Organization.identifier.type",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://mos.esante.gouv.fr/NOS/TRE_G07-TypeIdentifiantStructure/FHIR/TRE-G07-TypeIdentifiantStructure",
    ...
    {
      "id" : "Organization.identifier:sirene.system",
      "path" : "Organization.identifier.system",
    ...
    {
      "id" : "Organization.identifier:numSIRET",
      "path" : "Organization.identifier",
      "sliceName" : "numSIRET",
    ...
    {
      "id" : "Organization.identifier:numSIRET.type",
      "path" : "Organization.identifier.type",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "https://mos.esante.gouv.fr/NOS/TRE_G07-TypeIdentifiantStructure/FHIR/TRE-G07-TypeIdentifiantStructure",
    ...
    {
      "id" : "Organization.identifier:numSIRET.system",
      "path" : "Organization.identifier.system",
      "short" : "https://mos.esante.gouv.fr/6.html#_4d544200-4d26-4cc5-8294-c862458f60d8",
      "patternUri" : "https://sirene.fr"
    },
    {
    ...
    },
    {
      ...
      "short" : "sousEnsembleAgregatStatutJuridique (EJ) : Deuxième niveau dans l’arborescence des statuts juridiques",
      "min" : 0,
      "max" : "1",
      "mustSupport" : true,
      "binding" : {
      ...
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-ej",
        "map" : "sousEnsembleAgregatStatutJuridique",
        "comment" : "Similaire aux accès de metadonnee.identifiant"
      }]
    },
    {
    ...
    },
    {
      ...
      "short" : "raisonSociale (EJ) ou denominationEG (EG) ou nomOI (OI) - Remarque : Décalage provisoire de la cardinalité par rapport au modèle d'exposition (1..1)",
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-ej",
        "map" : "raisonSociale",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-organization-additional-name|0.7.0"]
      }],
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-ej",
    ...
    {
      "id" : "Organization.address.extension:inseeCode.extension",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://mos.esante.gouv.fr/NOS/JDV_J124-Commune/FHIR/JDV-J124-Commune|20260330120000"
      }
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/geolocation|5.2.0"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-confidence-geolocation|0.7.0"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-contact-description|0.7.0"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/ror/StructureDefinition/ror-contact-confidentiality-level|0.7.0"]
      }],
      "mustSupport" : true
    },
    {
