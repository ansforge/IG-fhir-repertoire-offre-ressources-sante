...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.ror|current/StructureDefinition/ror-contact-description)
...
Extension simple avec le type string : Extension créée dans le cadre du ROR qui indique la description du Contact.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-contact-description.csv), [Excel](../StructureDefinition-ror-contact-description.xlsx), [Schematron](../StructureDefinition-ror-contact-description.sch) 
