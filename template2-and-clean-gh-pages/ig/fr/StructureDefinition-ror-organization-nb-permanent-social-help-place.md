...
Extension simple avec le type integer : Extension créée dans le cadre du ROR pour indiquer le nombre de places permanentes dédiées à l'aide sociale dans l'établissement
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-organization-nb-permanent-social-help-place.csv), [Excel](../StructureDefinition-ror-organization-nb-permanent-social-help-place.xlsx), [Schematron](../StructureDefinition-ror-organization-nb-permanent-social-help-place.sch) 
