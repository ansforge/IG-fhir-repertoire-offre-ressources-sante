...
## Profil de ressource: RORPractitioner 
...
* The element 1 is sliced based on the value of Practitioner.meta.tag
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-practitioner.csv), [Excel](../StructureDefinition-ror-practitioner.xlsx), [Schematron](../StructureDefinition-ror-practitioner.sch) 
