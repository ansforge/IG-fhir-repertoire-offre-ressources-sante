...
Extension simple avec le type boolean : Extension créée dans le cadre du ROR pour préciser l’existence d’une zone de poser pour hélicoptère sur le site concerné.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-organization-drop-zone.csv), [Excel](../StructureDefinition-ror-organization-drop-zone.xlsx), [Schematron](../StructureDefinition-ror-organization-drop-zone.sch) 
