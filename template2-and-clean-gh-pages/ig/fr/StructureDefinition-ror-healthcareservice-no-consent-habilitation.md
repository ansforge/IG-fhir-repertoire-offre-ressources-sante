...
Extension simple avec le type boolean : Extension créée dans le cadre du ROR qui permet d'identifier les offres pour lesquelles un établissement est autorisé par le directeur général de l’ARS après avis du préfet, à prendre en charge des patients sans leur consentement.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-healthcareservice-no-consent-habilitation.csv), [Excel](../StructureDefinition-ror-healthcareservice-no-consent-habilitation.xlsx), [Schematron](../StructureDefinition-ror-healthcareservice-no-consent-habilitation.sch) 
