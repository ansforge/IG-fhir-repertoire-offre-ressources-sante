...
Extension complexe: Extension créée dans le cadre du ROR pour les télécommunications du contact.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-healthcareservice-contact-telecom.csv), [Excel](../StructureDefinition-ror-healthcareservice-contact-telecom.xlsx), [Schematron](../StructureDefinition-ror-healthcareservice-contact-telecom.sch) 
