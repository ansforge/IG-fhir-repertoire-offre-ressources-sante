...
Extension complexe: Extension créée dans le cadre du ROR qui précise les limites que peut supporter l'équipement le plus tolérant parmi les équipements spécifiques de même type dans cette organisation.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-location-equipment-limit.csv), [Excel](../StructureDefinition-ror-location-equipment-limit.xlsx), [Schematron](../StructureDefinition-ror-location-equipment-limit.sch) 
