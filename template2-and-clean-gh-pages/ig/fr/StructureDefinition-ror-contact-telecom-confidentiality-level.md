...
Extension simple avec le type CodeableConcept : Extension créée dans le cadre du ROR
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-contact-telecom-confidentiality-level.csv), [Excel](../StructureDefinition-ror-contact-telecom-confidentiality-level.xlsx), [Schematron](../StructureDefinition-ror-contact-telecom-confidentiality-level.sch) 
