...
Extension simple avec le type CodeableConcept : Extension créée dans le cadre du ROR pour définir le type de fermeture de l'organisation.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-organization-closing-type.csv), [Excel](../StructureDefinition-ror-organization-closing-type.xlsx), [Schematron](../StructureDefinition-ror-organization-closing-type.sch) 
