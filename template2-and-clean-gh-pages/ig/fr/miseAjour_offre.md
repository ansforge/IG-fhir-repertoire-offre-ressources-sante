# Mise à jour de l'offre - Répertoire national de l’Offre et des Ressources en santé et accompagnement médico-social v0.7.0
...
| | | |
| :--- | :--- | :--- |
| **Interaction FHIR** | Patch[[1]](#_ftn1) (limitée aux attributs de 'premier niveau') | Update[[2]](#_ftn2) |
| **Méthode http associée** | PATCH | PUT |
| **Ressource recherchée** | Organization, HealthcareService, Practitioner, PractitionerRole | Organization, HealthcareService, Practitioner, PractitionerRole |
| **Construction requête de base** | `PATCH [base]/[Ressource]/[id]{?&_format=[mime-type]}` | `PUT [base]/[Ressource]/[id]{?&_format=[mime-type]}` |
...
#### [spécifique serveur] Scénario 5 : Modification d'informations sur une situation opérationnelle draft
...
**Requête :** Voir [scénario 10 du cas d'usage saisie de l'offre](saisie_offre.md#spécifique-serveur-scénario-10-création-dune-situation-opérationnelle) (Création d'une situation opérationnelle)
...
**Requête :** Voir [scénario 1 du cas d'usage création et mise à jour du lieu de réalisation de l'offre](specifications_techniques_10.md#scénario-1-ajout-dun-lieu-de-réalisation-de-loffre-draft) (Ajout d’un lieu de réalisation de l’offre)
