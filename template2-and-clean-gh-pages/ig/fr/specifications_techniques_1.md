# Consultation des données capacitaires - Répertoire national de l’Offre et des Ressources en santé et accompagnement médico-social v0.7.0
...
* [StructureDefinition-ror-location](search_param.md#structuredefinition-ror-location)
* [StructureDefinition-ror-healthcareservice](search_param.md#structuredefinition-ror-healthcareservice) (critères de recherche applicables à la ressource Location, grâce au [chainage inversé](https://www.hl7.org/fhir/R4/search.html#has). Pour cela utiliser la syntaxe suivante :`_has:HealthcareService:location:[NOM CRITERE]`)
* [StructureDefinition-ror-task](search_param.md#structuredefinition-ror-task) (critères de recherche applicables à la ressource Location, grâce au [chainage inversé](https://www.hl7.org/fhir/R4/search.html#has). Pour cela utiliser la syntaxe suivante :`_has:HealthcareService:location:[NOM CRITERE]`)
...
#### Scénario 1bis : Données capacitaires sur une région draft
...
**Requête 1 :** `GET [BASE]/Location?identifier=11/339772,11/347254&_revinclude=HealthcareService:location`
