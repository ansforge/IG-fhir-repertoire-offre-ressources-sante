...
Extension simple avec le type date : Extension créée dans le cadre du ROR pour définir la date prévisionnelle de réouverture de l'organisation interne.
...
Autres représentations du profil : [CSV](../StructureDefinition-ror-organization-reopening-date.csv), [Excel](../StructureDefinition-ror-organization-reopening-date.xlsx), [Schematron](../StructureDefinition-ror-organization-reopening-date.sch) 
