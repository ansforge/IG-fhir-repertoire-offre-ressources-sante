...
* Refer to this Profile: [RORHealthcareService](StructureDefinition-ror-healthcareservice.md), [RORLocation](StructureDefinition-ror-location.md), [RORMeasureReport](StructureDefinition-ror-measurereport.md), [ROROrganization](StructureDefinition-ror-organization.md)... Show 3 more, [RORPractitioner](StructureDefinition-ror-practitioner.md), [RORPractitionerRole](StructureDefinition-ror-practitionerrole.md) and [RORTask](StructureDefinition-ror-task.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.ror|current/StructureDefinition/StructureDefinition-ror-organization.json)
