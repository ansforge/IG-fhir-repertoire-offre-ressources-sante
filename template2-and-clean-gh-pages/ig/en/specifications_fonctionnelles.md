# Specifications Fonctionnelles - Répertoire national de l’Offre et des Ressources en santé et accompagnement médico-social v0.7.0
...
**La maturité d'implémentation (cf [guide de lecture du guide](index.md#informations-sur-ce-guide-dimplémentation)) pour répondre à ces cas d'usage est indiqué dans les spécifications techniques.**

>  **Définition d’une Anomalie dans le ROR:** 
...
* Le non-respect d’une exigence qualité : toute offre ne respectant pas une exigence qualité sera être indiquée en écart par rapport à cette règle.  Exemple d’exigence : Les établissements sont peuplés selon les critères de peuplement définis par l'ANS → cet écart sera remonté au responsable d'établissement
...
* **Recherche capacité (modèle expo V3.0)**: 
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_1.md)**
...
* ** Extraction complète de l'offre**: 
  * **Extraction partielle de l'offre**: 
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_2.md)**
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_3.md)**
...
* **Recherche offre avec données capacitaires**: 
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_4.md)**

### Recherche d'offre sur la base d'informations tarifaires

#### Description du cas d'usage

* **Recherche d'offre sur la base d'informations tarifaires (modèle expo V3.0)**: 
...
* Un consommateur recherche les offres d'établissements dont le type de tarifs = 02 | forfait socle hébergement, le montant est inférieur à X euros, pour la date de début de validité la plus récente.
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_8.md)**
...
* **Recherche « Full text » (modèle expo V3.0)**: 
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_9.md)**
...
* **Création du lieu de réalisation de l'offre (modèle expo V3.0)**: 
...
* **Mise à jour du lieu de réalisation de l'offre (modèle expo V3.0)**: 
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_10.md)**
...
* **Création des modèles de saisie de l'offre (modèle expo V3.0)**: 
...
* **Recherche modèle de saisie de l'offre (modèle expo V3.0)**: 
...
**Les spécifications techniques pour répondre à ces cas d'usage sont accessibles [ici](modeles_de_saisie_offre.md)**
...
* **Saisie de l'offre (modèle expo V3.0)**: 
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](saisie_offre.md)**
...
* **Mise à jour de l'offre (modèle expo V3.0)**: 
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](miseAjour_offre.md)**
...
Le consommateur renseigne les informations de l’anomalie à signaler, en précisant à minima les éléments obligatoires. (voir description de la [ressource](StructureDefinition-ror-task.md)). Le ROR National répond au consommateur l’identifiant technique, les métadonnées et l’identifiant fonctionnel de l’anomalie créée.
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_5.md)**
...
Le service numérique renseigne l’identifiant technique de l’anomalie à mettre à jour et les informations à modifier (voir description de la [ressource](StructureDefinition-ror-task.md)). Le ROR National retourne au service numérique l’identifiant technique, les métadonnées et l’identifiant fonctionnel a minima de l’anomalie créée.
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_6.md)**
...
Le consommateur renseigne si besoin son (ses) critère(s) de recherche parmi les critères disponibles. Le ROR National répond au consommateur la ou les anomalies correspondantes aux critères de recherche.
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_7.md)**
...
* **Consultation d'indicateurs de pilotage (modèle expo V3.0)**: 
...
**Les spécifications techniques pour répondre à ce cas d'usage sont accessibles [ici](specifications_techniques_11.md)**
