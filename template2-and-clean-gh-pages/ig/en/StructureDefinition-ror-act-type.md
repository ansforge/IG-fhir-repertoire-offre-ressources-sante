...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.ror|current/StructureDefinition/StructureDefinition-ror-act-type.json)
...
Other representations of profile: [CSV](../StructureDefinition-ror-act-type.csv), [Excel](../StructureDefinition-ror-act-type.xlsx), [Schematron](../StructureDefinition-ror-act-type.sch) 
