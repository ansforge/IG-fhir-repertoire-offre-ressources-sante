...
* Use this Extension: [RORQuestionnaire](StructureDefinition-ror-questionnaire-healthcareservice.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.ror|current/StructureDefinition/StructureDefinition-ror-launchcontext.json)
