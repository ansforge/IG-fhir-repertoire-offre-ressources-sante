...
* Use this Extension: [ROROrganization](StructureDefinition-ror-organization.md) and [RORPractitionerRole](StructureDefinition-ror-practitionerrole.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.ror|current/StructureDefinition/StructureDefinition-ror-meta-comment.json)
