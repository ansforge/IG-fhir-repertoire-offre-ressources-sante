...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.ror|current/StructureDefinition/StructureDefinition-ror-practitionerrole-name.json)
...
Other representations of profile: [CSV](../StructureDefinition-ror-practitionerrole-name.csv), [Excel](../StructureDefinition-ror-practitionerrole-name.xlsx), [Schematron](../StructureDefinition-ror-practitionerrole-name.sch) 
