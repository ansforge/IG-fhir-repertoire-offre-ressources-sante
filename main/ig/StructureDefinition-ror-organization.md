...
| Draft as of 2026-07-23 | *Computable Name*:ROROrganization |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-careOf"]
      }],
      "mustSupport" : true,
      "mapping" : [{
        "identity" : "specmetier-to-ROROrganization-ej",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-ext-lieu-dit"]
      }],
      "mustSupport" : true
    },
    {
