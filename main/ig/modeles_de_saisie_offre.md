# Modèles de saisie de l'offre - Répertoire national de l’Offre et des Ressources en santé et accompagnement médico-social v0.7.0

* [**Table of Contents**](toc.md)
* **Modèles de saisie de l'offre**
...
| | | |
| :--- | :--- | :--- |
| **Interaction FHIR** | Create[[1]](#_ftn1)Update[[2]](#_ftn2) | Search[[3]](#_ftn3) |
| **Méthode http associée** | POSTPUT | GET |
| **Ressource(s) ciblée(s)** | [Questionnaire](https://hl7.org/fhir/R4/questionnaire.html) | [Questionnaire](https://hl7.org/fhir/R4/questionnaire.html) |
| **Construction requête de base** | `POST [base]/Questionnaire {?_format=[mime-type]}``PUT [base]/Questionnaire/[id]{?&_format=[mime-type]}` | `GET [base]/Questionnaire{?[parameters]{&_format=[mime-type]}}` |

 

[[1]](#_ftnref1) [https://hl7.org/fhir/R4/http.html#create](https://hl7.org/fhir/R4/http.html#create) et [https://www.hl7.org/fhir/R4/http.html#general](https://hl7.org/fhir/R4/http.html#general)

[[2]](#_ftnref2) [https://hl7.org/fhir/R4/http.html#update](https://hl7.org/fhir/R4/http.html#update) et [http://hl7.org/fhir/R4/http.html#general](http://hl7.org/fhir/R4/http.html#general)  

[[3]](#_ftnref3) [https://hl7.org/fhir/R4/http.html#search](https://hl7.org/fhir/R4/http.html#search) et [http://hl7.org/fhir/R4/http.html#general](http://hl7.org/fhir/R4/http.html#general)  
...
Les critères de recherche applicables pour RORQuestionnaire sont accesible ici : [paragraphe dédié](search_param.md#structuredefinition-ror-questionnaire).
...
#### Scénario 1 : Création d’un modèle de saisie draft
...
#### Scénario 2 : Un consommateur souhaite récupérer l’ensemble des modèles draft
...
#### Scénario 3 : Un consommateur souhaite récupérer un modèle draft
...
#### Scénario 4 : Un consommateur souhaite récupérer un ensemble de modèles de saisie sur un critère donné draft
...
* utiliser les critères de recherche défini au [paragraphe dédié](search_param.md#structuredefinition-ror-questionnaire)
