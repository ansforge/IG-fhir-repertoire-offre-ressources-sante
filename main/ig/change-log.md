# Historique des versions - Répertoire national de l’Offre et des Ressources en santé et accompagnement médico-social v0.7.0
...
**Release 0.7.0 de l’Implementation Guide FHIR du ROR compatible avec le modèle d’exposition 3.0.1 du ROR et ayant pour cible l’implementation 5.1 du ROR national.** **En plus du périmètre ci-dessous, cette version contient le périmètre des versions 0.7.0-snapshot-1 et 0.7.0-snapshot-2**

URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.7.0](https://interop.esante.gouv.fr/ig/fhir/ror/0.7.0)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.7.0-snapshot-2](https://interop.esante.gouv.fr/ig/fhir/ror/0.7.0-snapshot-2)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.7.0-snapshot-1](https://interop.esante.gouv.fr/ig/fhir/ror/0.7.0-snapshot-1)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.6.0](https://interop.esante.gouv.fr/ig/fhir/ror/0.6.0)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.5.0](https://interop.esante.gouv.fr/ig/fhir/ror/0.5.0)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.4.0](https://interop.esante.gouv.fr/ig/fhir/ror/0.4.0)
...
* [narratif] Modification du tableau référençant les [Search Params pour ROROrganization](search_param.md#structuredefinition-ror-organization) [374](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/374)
* [narratif] Correction de l’exemple de requête (code inactivation) dans le [scénario 2 : Inactivation d’une anomalie](specifications_techniques_6.md#scénario-2-inactivation-dune-anomalie) [360](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/360), [361](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/361)
* [narratif] Ajout de la description du cas d’usage “Consignes fiche de saisie de l’offre” dans la page [Spécifications fonctionnelles](specifications_fonctionnelles.md#consignes-fiche-de-saisie-de-loffre) [365](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/365)
* correction de l’exemple de ressouce dans le [scénario 1 “Création du nouveau lieu de réalisation de l’offre”](specifications_techniques_10.md#spécifique-serveur-scénario-1-ajout-dun-lieu-de-réalisation-de-loffre-draft) [384](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/384)
...
Version qui inclut également les modifications réalisées pour la [version 0.4.0 snapshot-1](change-log.md#version-040-snapshot-1).
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.4.0-snapshot-1](https://interop.esante.gouv.fr/ig/fhir/ror/0.4.0-snapshot-1)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.3.0](https://interop.esante.gouv.fr/ig/fhir/ror/0.3.0)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.2.0](https://interop.esante.gouv.fr/ig/fhir/ror/0.2.0)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.1.1](https://interop.esante.gouv.fr/ig/fhir/ror/0.1.1)
...
URL : [https://interop.esante.gouv.fr/ig/fhir/ror/0.1.0](https://interop.esante.gouv.fr/ig/fhir/ror/0.1.0)
